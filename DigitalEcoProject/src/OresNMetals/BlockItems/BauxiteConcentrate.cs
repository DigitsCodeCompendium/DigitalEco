...
namespace Eco.Mods.TechTree
{
    ...
    [Ecopedia("Blocks", "Processed Rock", subPageName: "Bauxite Concentrate Item")]
    public partial class BauxiteConcentrateRecipe : RecipeFamily
    {
        public BauxiteConcentrateRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "BauxiteConcentrate",  //noloc
                displayName: Localizer.DoStr("Bauxite Concentrate"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(CrushedBauxiteOreItem), 7, typeof(MiningSkill)),
                },
                ...
                {
                    new CraftingElement<BauxiteConcentrateItem>(),
            ...
            this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(BauxiteConcentrateRecipe), start: 1.5f, skillType: typeof(MiningSkill));

            // Perform pre/post initialization for user mods and initialize our recipe instance with the display name "Bauxite Concentrate"
            this.ModsPreInitialize();
            this.Initialize(displayText: Localizer.DoStr("Bauxite Concentrate"), recipeType: typeof(BauxiteConcentrateRecipe));
