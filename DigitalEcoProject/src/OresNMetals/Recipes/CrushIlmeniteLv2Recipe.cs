...
namespace Eco.Mods.TechTree
{
	...
	public partial class CrushIlmeniteLv2Recipe : RecipeFamily
	{
		public CrushIlmeniteLv2Recipe()
		{
			var recipe = new Recipe();
			recipe.Init(
				name: "CrushIlmeniteLv2",
				displayName: Localizer.DoStr("Crush Ilmenite Lv2"),
			...
			this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(CrushIlmeniteLv2Recipe), start: 2f, skillType: typeof(MiningSkill));
