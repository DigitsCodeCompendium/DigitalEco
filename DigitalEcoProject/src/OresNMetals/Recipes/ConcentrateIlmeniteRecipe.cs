...
namespace Eco.Mods.TechTree
{
	...
	public partial class ConcentrateIlmeniteRecipe : RecipeFamily
	{
		public ConcentrateIlmeniteRecipe()
		{
			var recipe = new Recipe();
			recipe.Init(
				name: "ConcentrateIlmenite",
			...
			this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(ConcentrateIlmeniteRecipe), start: 1.5f, skillType: typeof(MiningSkill));

			this.ModsPreInitialize();
			this.Initialize(displayText: Localizer.DoStr("Concentrate Ilmenite"), recipeType: typeof(ConcentrateIlmeniteRecipe));
