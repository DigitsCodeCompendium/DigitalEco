...
namespace Eco.Mods.TechTree
{
	...
	public partial class MalachiteCopperLv2Recipe : RecipeFamily
	{
		public MalachiteCopperLv2Recipe()
		{
			var recipe = new Recipe();
			recipe.Init(
				name: "MalachiteCopperLv2",
				displayName: Localizer.DoStr("Malachite Copper Lv2"),
			...
			this.CraftMinutes = CreateCraftTimeValue(beneficiary: typeof(MalachiteCopperLv2Recipe), start: 2f, skillType: typeof(SmeltingSkill), typeof(SmeltingFocusedSpeedTalent), typeof(SmeltingParallelSpeedTalent));
