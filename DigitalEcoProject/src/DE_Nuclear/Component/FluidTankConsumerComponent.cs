...
namespace Digits.Nuclear
{
    ...
    public class FluidTankConsumerComponent : WorldObjectComponent, IController, IWireContainer
    {
        ...
        private FluidTankComponent converter; // optional converter which may be used to convert consumed liquid
        ...
        public void Setup(Type acceptedType, float consumptionRate, BlockOccupancyType blockOccupancyType, float percentRequiredFlow, FluidTankComponent converter = null)
        {
