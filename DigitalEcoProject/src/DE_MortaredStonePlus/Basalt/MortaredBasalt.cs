...
namespace Eco.Mods.TechTree
{
    ...
    [ForceCreateView]
    [Ecopedia("Blocks", "Building Materials", subPageName: "Mortared Basalt Item")]
    public partial class MortaredBasaltRecipe : Recipe
    {
        public MortaredBasaltRecipe()
        {
            this.Init(
                name: "MortaredBasalt",  //noloc
                displayName: Localizer.DoStr("Mortared Basalt"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement(typeof(BasaltItem), 4, typeof(MasonrySkill), typeof(MasonryLavishResourcesTalent)),
                ...
                {
                    new CraftingElement<MortaredBasalt2Item>()
                });
    ...
    public partial class MortaredBasaltBlock :
        ...
        , IRepresentsItem
    {
        public virtual Type RepresentedItemType { get { return typeof(MortaredBasalt2Item); } }
    }
    ...
    [Tag("Constructable")]
    [Tier(1)]
    public partial class MortaredBasalt2Item :
