...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Basic Windmill Sails")]
    public partial class BasicWindmillSailsRecipe : RecipeFamily
    {
        public BasicWindmillSailsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "BasicWindmillSails",
                displayName: Localizer.DoStr("Basic Windmill Sails"),
                ...
                {
                    new CraftingElement<BasicWindmillSailsItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Basic Windmill Sails"), typeof(BasicWindmillSailsRecipe));
    ...
    [Serialized]
    [LocDisplayName("Basic Windmill Sails")]
    ...
    [Weight(1000)]
    [Category("Tool")]
    [Tag("Windmill Sails"), Tag("MTier 2")]
    [Ecopedia("Maintenance Items", "Bench Tools", createAsSubPage: true)]
    public partial class BasicWindmillSailsItem : RepairableItem
    {
