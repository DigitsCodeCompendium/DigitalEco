...
namespace Eco.Mods.TechTree
{
    ...
    public partial class MachinistTableObject
    {
        partial void ModsPreInitialize()
        {
            ...
            mComp.CreatePartSlot("Industrial Belt");
            mComp.AddPartSlotRestriction("Industrial Belt", 
                new MaintenanceTypesRestriction("Industrial Belt", new string[] { "MTier 2", "MTier 4" }));
            mComp.AddPartSlotDegradation("Industrial Belt",
                new Dictionary<string, float>() { { "degOnCraftTick", 100f/(4f*60f*60f) } });
        }
    }
}