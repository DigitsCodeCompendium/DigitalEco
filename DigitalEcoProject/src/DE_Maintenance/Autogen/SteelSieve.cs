...
namespace Digits.Maintenance
{
    ...
    public partial class SteelSieveRecipe : RecipeFamily
    {
        public SteelSieveRecipe()
        {
            ...
            recipe.Init(
                ...
                {  new IngredientElement(typeof(SteelBarItem), 12, typeof(TailoringSkill), typeof(TailoringLavishResourcesTalent)), },
    ...
    [LocDescription("A steel wire sieve for seperating out small particles")]
    [RepairRequiresSkill(typeof(TailoringSkill), 1)]
    [Weight(1000)]
    [Category("Tool")]
    [Tag("Sieve"), Tag("MTier 3")]
    [Ecopedia("Maintenance Items", "Bench Tools", createAsSubPage: true)]
    public partial class SteelSieveItem : RepairableItem
    {
        public override Item RepairItem                 => Item.Get<SteelBarItem>();
        public override int FullRepairAmount            => 11;
        //set durability by changing the denominator below
        public override float DurabilityRate            => DurabilityMax / 500f;
        public override IDynamicValue SkilledRepairCost => new SkillModifiedValue(11, SmeltingSkill.MultiplicativeStrategy, typeof(TailoringSkill), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
    }
}