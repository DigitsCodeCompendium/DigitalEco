...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SettlementCraftingTableObject
    {
        partial void ModsPreInitialize()
        {
            ...
            mComp.CreatePartSlot("Scribe Set");
            mComp.AddPartSlotRestriction("Scribe Set", 
                new MaintenanceTypesRestriction("Scribe Set", new string[] { "MTier 1", "MTier 2", "MTier 3", "MTier 4" }));
            mComp.AddPartSlotDegradation("Scribe Set",
                new Dictionary<string, float>() { { "degOnCraftTick", 100f/(4f*60f*60f) } });
        }
    }
}