...
namespace Digits.Maintenance
{
    ...
    public partial class IronStampingDieItem : RepairableItem
    {
        ...
        public override int FullRepairAmount            => 22;
        //set durability by changing the denominator below
        public override float DurabilityRate            => DurabilityMax / 300f;
        public override IDynamicValue SkilledRepairCost => new SkillModifiedValue(22, SmeltingSkill.MultiplicativeStrategy, typeof(MechanicsSkill), Localizer.DoStr("repair cost"), DynamicValueType.Efficiency);
    }
}