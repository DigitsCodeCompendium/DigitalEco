...
namespace Eco.Mods.TechTree
{
    ...
    public partial class BakeryOvenObject
    {
        partial void ModsPreInitialize()
        {
            ...
            mComp.CreatePartSlot("Oven Insulation");
            mComp.AddPartSlotRestriction("Oven Insulation", 
                new MaintenanceTypesRestriction("Oven Insulation", new string[] { "MTier 2", "MTier 3", "MTier 4" }));
            mComp.AddPartSlotDegradation("Oven Insulation",
                new Dictionary<string, float>() { { "degOnCraftTick", 100f/(4f*60f*60f) } });
        }
    }
}