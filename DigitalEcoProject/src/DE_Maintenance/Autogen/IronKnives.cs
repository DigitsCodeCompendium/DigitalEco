    ...
    public partial class IronKnivesRecipe : RecipeFamily
    {
        public IronKnivesRecipe()
        {
            ...
            recipe.Init(
                ...
                { new IngredientElement(typeof(IronBarItem), 10, typeof(SmeltingSkill), typeof(SmeltingLavishResourcesTalent)), new IngredientElement("Lumber", 5, typeof(SmeltingSkill), typeof(SmeltingLavishResourcesTalent)), },
