    ...
    public partial class SolderSpoolRecipe : RecipeFamily
    {
        public SolderSpoolRecipe()
        {
            ...
            recipe.Init(
                ...
                { new IngredientElement(typeof(CopperWiringItem), 5, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingLavishResourcesTalent)), new IngredientElement(typeof(GoldWiringItem), 1, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingLavishResourcesTalent)), },
