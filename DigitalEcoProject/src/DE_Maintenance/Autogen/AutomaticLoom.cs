...
namespace Eco.Mods.TechTree
{
    ...
    public partial class AutomaticLoomObject
    {
        partial void ModsPreInitialize()
        {
            ...
            mComp.CreatePartSlot("Capacitor Kit");
            mComp.AddPartSlotRestriction("Capacitor Kit", 
                new MaintenanceTypesRestriction("Capacitor Kit", new string[] { "MTier 4" }));
            mComp.AddPartSlotDegradation("Capacitor Kit",
                new Dictionary<string, float>() { { "degOnCraftTick", 100f/(4f*60f*60f) } });
        }
    }
}