...
namespace Eco.Mods.TechTree
{
    ...
    public partial class SawmillObject
    {
        partial void ModsPreInitialize()
        {
            ...
            mComp.CreatePartSlot("Sawblade Kit");
            mComp.AddPartSlotRestriction("Sawblade Kit", 
                new MaintenanceTypesRestriction("Sawblade Kit", new string[] { "MTier 2", "MTier 3", "MTier 4" }));
            mComp.AddPartSlotDegradation("Sawblade Kit",
                new Dictionary<string, float>() { { "degOnCraftTick", 100f/(4f*60f*60f) } });
        }
    }
}