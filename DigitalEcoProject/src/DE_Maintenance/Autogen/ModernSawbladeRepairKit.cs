    ...
    public partial class ModernSawbladeRepairKitRecipe : RecipeFamily
    {
        public ModernSawbladeRepairKitRecipe()
        {
            ...
            recipe.Init(
                ...
                { new IngredientElement(typeof(SteelBarItem), 5, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingLavishResourcesTalent)), new IngredientElement("CompositeLumber", 3, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingLavishResourcesTalent)), new IngredientElement(typeof(EpoxyItem), 4, typeof(AdvancedSmeltingSkill), typeof(AdvancedSmeltingLavishResourcesTalent)), },
