...
{
    /// <summary>
    /// <para>Server side recipe definition for "Tier 4 Machine Frames".</para>
    /// <para>Machine frames make up the core of most machines.</para>
    /// </summary>
    [RequiresSkill(typeof(LoggingSkill), 1)]
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Machine Parts Item")]
    public partial class PrimitiveTier4MachineFrameRecipe : RecipeFamily
    {
        public PrimitiveTier4MachineFrameRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrimitiveTier4MachineFrame",  //noloc
                displayName: Localizer.DoStr("Primitive Tier 4 Machine Frame"),
                ...
                {
                    new CraftingElement<PrimitiveTier4MachineFrameItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Primitive Tier 4 Machine Frame"), typeof(PrimitiveTier4MachineFrameRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "Tier4MachineFrame" item.</para>
    ...
    /// </summary>
    [Serialized] 
    [LocDisplayName("Primitive Tier 4 Machine Frame"), LocDescription("A machine frame keeps everything together and in place")]
    [Tier(4)]
    ...
    public partial class PrimitiveTier4MachineFrameItem : RepairableItem, ISlottableItem
    {
