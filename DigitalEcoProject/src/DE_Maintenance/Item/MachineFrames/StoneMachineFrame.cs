...
namespace Digits.Maintenance
{
    ...
    public partial class StoneMachineFrameRecipe : RecipeFamily
    {
        public StoneMachineFrameRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "StoneMachineFrame",  //noloc
                displayName: Localizer.DoStr("Stone Machine Frame"),

                // Defines the ingredients needed to craft this recipe. An ingredient items takes the following inputs
                // type of the item, the amount of the item, the skill required, and the talent used.
                ingredients: new List<IngredientElement>
                {
                    new IngredientElement("Rock", 1, typeof(LoggingSkill)), //noloc
                },
                ...
                {
                    new CraftingElement<StoneMachineFrameItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Stone Machine Frame"), typeof(StoneMachineFrameRecipe));
    ...
    /// </summary>
    [Serialized]
    [LocDisplayName("Stone Machine Frame"), LocDescription("A machine frame keeps everything together and in place")]
    [Tier(1)]
    ...
    public partial class StoneMachineFrameItem : RepairableItem, ISlottableItem
    {
