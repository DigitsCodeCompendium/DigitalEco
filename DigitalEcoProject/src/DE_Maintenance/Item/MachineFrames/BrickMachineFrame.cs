...
namespace Digits.Maintenance
{
    ...
    public partial class BrickMachineFrameRecipe : RecipeFamily
    {
        public BrickMachineFrameRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "BrickMachineFrame",  //noloc
                displayName: Localizer.DoStr("Brick Machine Frame"),
                ...
                {
                    new CraftingElement<BrickMachineFrameItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Brick Machine Frame"), typeof(BrickMachineFrameRecipe));
    ...
    /// </summary>
    [Serialized]
    [LocDisplayName("Brick Machine Frame"), LocDescription("A machine frame keeps everything together and in place")]
    [Tier(1)]
    ...
    public partial class BrickMachineFrameItem : RepairableItem, ISlottableItem
    {
