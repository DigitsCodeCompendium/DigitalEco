...
namespace Digits.Maintenance
{
    ...
    public partial class AshlarMachineFrameRecipe : RecipeFamily
    {
        public AshlarMachineFrameRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "AshlarMachineFrame",  //noloc
                displayName: Localizer.DoStr("Ashlar Machine Frame"),
                ...
                {
                    new CraftingElement<AshlarMachineFrameItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Ashlar Machine Frame"), typeof(AshlarMachineFrameRecipe));
    ...
    /// </summary>
    [Serialized]
    [LocDisplayName("Ashlar Machine Frame"), LocDescription("A machine frame keeps everything together and in place")]
    [Tier(4)]
    ...
    public partial class AshlarMachineFrameItem : RepairableItem, ISlottableItem
    {
