...
namespace Digits.Maintenance
{
    ...
    public partial class PrimitiveTier2MachineFrameRecipe : RecipeFamily
    {
        public PrimitiveTier2MachineFrameRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "PrimitiveTier2MachineFrame",  //noloc
                displayName: Localizer.DoStr("Primitive Tier 2 Machine Frame"),
                ...
                {
                    new CraftingElement<PrimitiveTier2MachineFrameItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Primitive Tier 2 Machine Frame"), typeof(PrimitiveTier2MachineFrameRecipe));
    ...
    /// </summary>
    [Serialized] 
    [LocDisplayName("Primitive Tier 2 Machine Frame"), LocDescription("A machine frame keeps everything together and in place")]
    [Tier(2)]
    [RepairRequiresSkill(typeof(SmeltingSkill), 0)]
    [Weight(500)]
    [Category("Machine Frames")]
    [Tag("Maintenance Machine Frame"), Tag("Maintenance Tier 2")]
    [Ecopedia("Maintenance Items", "Machine Frames", createAsSubPage: true)]
    public partial class PrimitiveTier2MachineFrameItem : RepairableItem, ISlottableItem
    {
