...
namespace Digits.Maintenance
{
    ...
    public partial class ConcreteMachineFrameRecipe : RecipeFamily
    {
        public ConcreteMachineFrameRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ConcreteMachineFrame",  //noloc
                displayName: Localizer.DoStr("Concrete Machine Frame"),
                ...
                {
                    new CraftingElement<ConcreteMachineFrameItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Concrete Machine Frame"), typeof(ConcreteMachineFrameRecipe));
    ...
    /// </summary>
    [Serialized]
    [LocDisplayName("Concrete Machine Frame"), LocDescription("A machine frame keeps everything together and in place")]
    [Tier(3)]
    ...
    public partial class ConcreteMachineFrameItem : RepairableItem, ISlottableItem
    {
