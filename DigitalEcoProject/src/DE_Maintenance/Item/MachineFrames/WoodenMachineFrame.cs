...
namespace Digits.Maintenance
{
    ...
    public partial class WoodenMachineFrameRecipe : RecipeFamily
    {
        public WoodenMachineFrameRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "WoodenMachineFrame",  //noloc
                displayName: Localizer.DoStr("Wooden Machine Frame"),
                ...
                {
                    new CraftingElement<WoodenMachineFrameItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Wooden Machine Frame"), typeof(WoodenMachineFrameRecipe));
    ...
    /// </summary>
    [Serialized]
    [LocDisplayName("Wooden Machine Frame"), LocDescription("A machine frame keeps everything together and in place")]
    [Tier(1)]
    ...
    public partial class WoodenMachineFrameItem : RepairableItem, ISlottableItem
    {
