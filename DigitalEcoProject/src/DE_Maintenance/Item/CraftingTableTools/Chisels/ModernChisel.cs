...
namespace Digits.Maintenance
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "ModernChisel" item.</para>
    ...
    [LocDescription("Modern Chisel are primitive tools for shaping rock")]
    [Tier(1)]
