...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Modern Sieving Mesh")]
    public partial class ModernSievingMeshRecipe : RecipeFamily
    {
        public ModernSievingMeshRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ModernSieving Mesh",  //noloc
                displayName: Localizer.DoStr("Modern Sieving Mesh"),
                ...
                {
                    new CraftingElement<ModernSievingMeshItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Modern Sieving Mesh"), typeof(ModernSievingMeshRecipe));
    ...
    /// <summary>
    /// <para>Server side item definition for the "ModernSieving Mesh" item.</para>
    ...
    /// </summary>
    [Serialized]
    [LocDisplayName("Modern Sieving Mesh")]
    [LocDescription("Modern Sieving Mesh are primitive tools for shaping rock")]
    [Tier(1)]
    ...
    public partial class ModernSievingMeshItem : RepairableItem, ISlottableItem
    {
