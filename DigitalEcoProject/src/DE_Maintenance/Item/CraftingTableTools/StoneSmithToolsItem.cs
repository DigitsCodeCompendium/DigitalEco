...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Stone Smith's Tools")]
    public partial class StoneSmithToolsRecipe : RecipeFamily
    {
        public StoneSmithToolsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "StoneSmithTools",
                displayName: Localizer.DoStr("Stone Smith's Tools"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<StoneSmithToolsItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Stone Smith's Tools"), typeof(StoneSmithToolsRecipe));
    ...
    [Serialized]
    [LocDisplayName("Stone Smith's Tools")]
    [LocDescription("A set of tools commonly used for smithing.")]
    [Tier(1)]
    [RepairRequiresSkill(typeof(LoggingSkill), 1)]
    [Weight(500)]
    [Category("tool")]
    [Tag("Maintenance Tool Smith"), Tag("Maintenance Tier 1")]
    [Ecopedia("Maintenance Items", "Bench Tools", createAsSubPage: true)]
    public partial class StoneSmithToolsItem : RepairableItem, ISlottableItem
    {
