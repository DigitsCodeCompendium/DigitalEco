...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Steel Crushing Wheel")]
    public partial class SteelCrushingWheelRecipe : RecipeFamily
    {
        public SteelCrushingWheelRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteelCrushingWheel",
                displayName: Localizer.DoStr("Steel Crushing Wheel"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<SteelCrushingWheelItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Steel Crushing Wheel"), typeof(SteelCrushingWheelRecipe));
    ...
    [Serialized]
    [LocDisplayName("Steel Crushing Wheel")]
    [LocDescription("A large heavy wheel used for crushing.")]
    [Tier(1)]
    [RepairRequiresSkill(typeof(LoggingSkill), 1)]
    [Weight(5000)]
    [Category("tool")]
    [Tag("Maintenance Tool Crushing Wheel"), Tag("Maintenance Tier 3")]
    [Ecopedia("Maintenance Items", "Bench Tools", createAsSubPage: true)]
    public partial class SteelCrushingWheelItem : RepairableItem, ISlottableItem
    {
