...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Iron Crushing Wheel")]
    public partial class IronCrushingWheelRecipe : RecipeFamily
    {
        public IronCrushingWheelRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "IronCrushingWheel",
                displayName: Localizer.DoStr("Iron Crushing Wheel"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<IronCrushingWheelItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Iron Crushing Wheel"), typeof(IronCrushingWheelRecipe));
    ...
    [Serialized]
    [LocDisplayName("Iron Crushing Wheel")]
    [LocDescription("A large heavy wheel used for crushing.")]
    [Tier(1)]
    [RepairRequiresSkill(typeof(LoggingSkill), 1)]
    [Weight(5000)]
    [Category("tool")]
    [Tag("Maintenance Tool Crushing Wheel"), Tag("Maintenance Tier 2")]
    [Ecopedia("Maintenance Items", "Bench Tools", createAsSubPage: true)]
    public partial class IronCrushingWheelItem : RepairableItem, ISlottableItem
    {
