...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Steel Smith's Tools")]
    public partial class SteelSmithToolsRecipe : RecipeFamily
    {
        public SteelSmithToolsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteelSmithTools",
                displayName: Localizer.DoStr("Steel Smith's Tools"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<SteelSmithToolsItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Steel Smith's Tools"), typeof(SteelSmithToolsRecipe));
    ...
    [Serialized]
    [LocDisplayName("Steel Smith's Tools")]
    [LocDescription("A set of tools commonly used for smithing.")]
    [Tier(1)]
    [RepairRequiresSkill(typeof(LoggingSkill), 1)]
    [Weight(500)]
    [Category("tool")]
    [Tag("Maintenance Tool Smith"), Tag("Maintenance Tier 3")]
    [Ecopedia("Maintenance Items", "Bench Tools", createAsSubPage: true)]
    public partial class SteelSmithToolsItem : RepairableItem, ISlottableItem
    {
