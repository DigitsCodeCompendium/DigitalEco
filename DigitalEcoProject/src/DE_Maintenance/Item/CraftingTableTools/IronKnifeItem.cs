...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Iron Knife Set")]
    public partial class IronKnifeSetRecipe : RecipeFamily
    {
        public IronKnifeSetRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "IronKnifeSet",
                displayName: Localizer.DoStr("Iron Knife Set"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<IronKnifeSetItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Iron Knife Set"), typeof(IronKnifeSetRecipe));
    ...
    public partial class IronKnifeSetItem : RepairableItem, ISlottableItem
    {
