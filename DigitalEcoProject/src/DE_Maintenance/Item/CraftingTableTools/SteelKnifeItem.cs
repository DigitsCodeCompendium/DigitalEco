...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Steel Knife Set")]
    public partial class SteelKnifeSetRecipe : RecipeFamily
    {
        public SteelKnifeSetRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "SteelKnifeSet",
                displayName: Localizer.DoStr("Steel Knife Set"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<SteelKnifeSetItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Steel Knife Set"), typeof(SteelKnifeSetRecipe));
    ...
    [Serialized]
    [LocDisplayName("Steel Knife Set")]
    ...
    public partial class SteelKnifeSetItem : RepairableItem, ISlottableItem
    {
