...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Modern Smith's Tools")]
    public partial class ModernSmithToolsRecipe : RecipeFamily
    {
        public ModernSmithToolsRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "ModernSmithTools",
                displayName: Localizer.DoStr("Modern Smith's Tools"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<ModernSmithToolsItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Modern Smith's Tools"), typeof(ModernSmithToolsRecipe));
    ...
    [Serialized]
    [LocDisplayName("Modern Smith's Tools")]
    [LocDescription("A set of tools commonly used for smithing.")]
    [Tier(1)]
    [RepairRequiresSkill(typeof(LoggingSkill), 1)]
    [Weight(500)]
    [Category("tool")]
    [Tag("Maintenance Tool Smith"), Tag("Maintenance Tier 4")]
    [Ecopedia("Maintenance Items", "Bench Tools", createAsSubPage: true)]
    public partial class ModernSmithToolsItem : RepairableItem, ISlottableItem
    {
