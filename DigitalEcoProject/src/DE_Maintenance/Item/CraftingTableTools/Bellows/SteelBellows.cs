...
namespace Digits.Maintenance
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "SteelBellows" item.</para>
    ...
    [LocDescription("Steel Bellows are primitive tools for shaping rock")]
    [Tier(1)]
