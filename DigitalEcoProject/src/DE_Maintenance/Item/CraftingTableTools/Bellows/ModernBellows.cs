...
namespace Digits.Maintenance
{
    ...
    /// <summary>
    /// <para>Server side item definition for the "ModernBellows" item.</para>
    ...
    [LocDescription("Modern Bellows are primitive tools for shaping rock")]
    [Tier(1)]
    ...
    public partial class ModernBellowsItem : RepairableItem, ISlottableItem
    {
