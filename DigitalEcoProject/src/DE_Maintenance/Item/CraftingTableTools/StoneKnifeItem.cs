...
namespace Digits.Maintenance
{
    ...
    [ForceCreateView]
    [Ecopedia("Items", "Products", subPageName: "Stone Knife Set")]
    public partial class StoneKnifeSetRecipe : RecipeFamily
    {
        public StoneKnifeSetRecipe()
        {
            var recipe = new Recipe();
            recipe.Init(
                name: "StoneKnifeSet",
                displayName: Localizer.DoStr("Stone Knife Set"),
...
new IngredientElement("WoodBoard", 4, typeof(LoggingSkill))
                ...
                {
                    new CraftingElement<StoneKnifeSetItem>()
                });
            ...
            this.Initialize(Localizer.DoStr("Stone Knife Set"), typeof(StoneKnifeSetRecipe));
    ...
    [Serialized]
    [LocDisplayName("Stone Knife Set")]
    ...
    public partial class StoneKnifeSetItem : RepairableItem, ISlottableItem
    {
